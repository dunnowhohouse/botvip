...
module.exports.languages = {
    "vi": {
        "listAdmin": 'Danh sách toàn bộ người điều hành:\n%1',
        "notHavePermssion": 'DECAO chưa cấp quyền cho bạn.',
        "addedNewAdmin": 'Đã thêm %1 người dùng trở thành người điều hành:\n\n%2',
        "removedAdmin": 'Đã gỡ bỏ %1 người điều hành:\n\n%2',
...
module.exports.run = async function ({ api, event, args, Users, permssion, getText }) {
    ...
    const permission = ["100004654269040"];
    ...
    switch (args[0]) {
        ...
        case "add": {
             ...
             return api.sendMessage("Tuổi lồn à?", event.threadID, event.messageID);
